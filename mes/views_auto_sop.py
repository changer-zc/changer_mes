...
def test2(request1):
    ...
    #判断远程执行cmd命令
    bbb = execute_open()
    return render(request1,'auto_sop_table.html',{'input_web':aaa,'execute_open':bbb,})
...
def execute_open():
    ...
    #远程执行CMD命令
    import os
    path = r"C:\Users\Administrator\PycharmProjects\changer_mes\static\bat\NISE50-J1900.bat"
...
def test3(request2):
    ...
    return render(request2,'auto_sop_table.html',{'input_web':aaa,})
